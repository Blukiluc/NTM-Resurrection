...
public class ModuleAssemblyMachine extends ModuleMachineBase {

    public ModuleAssemblyMachine(int index, IEnergyHandlerMK2 battery, NonNullList<ItemStack> slots) {
    ...
    public ModuleAssemblyMachine itemInput(int from) { for(int i = 0; i < inputSlots.length; i++) inputSlots[i] = from + i; return this; }
    public ModuleAssemblyMachine itemOutput(int a) { outputSlots[0] = a; return this; }
    public ModuleAssemblyMachine fluidInput(FluidTank a) { inputTanks[0] = a; return this; }
    public ModuleAssemblyMachine fluidOutput(FluidTank a) { outputTanks[0] = a; return this; }
}
