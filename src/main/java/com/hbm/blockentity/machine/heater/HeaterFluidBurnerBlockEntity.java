...
public class HeaterFluidBurnerBlockEntity extends AbstractHeaterMachineBlockEntity implements IFluidStandardTransceiverMK2, IControlReceiver, IFluidCopiable {
    ...
    public HeaterFluidBurnerBlockEntity(BlockPos pos, BlockState state) {
        super(NtmBlockEntityTypes.HEATER_FLUID_BURNER.get(), pos, state, 3);
    }

    @Override
    protected Component getDefaultName() {
        return Component.translatable("container.heaterFluidBurner");
    }
    ...
    public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
        return new HeaterFluidBurnerMenu(id, inventory, this);
    }
