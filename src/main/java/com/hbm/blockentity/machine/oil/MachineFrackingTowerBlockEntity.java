...
public class MachineFrackingTowerBlockEntity extends OilDrillBaseBlockEntity {
    ...
    public MachineFrackingTowerBlockEntity(BlockPos pos, BlockState state) {
        super(NtmBlockEntityTypes.FRACKING_TOWER.get(), pos, state);
    ...
    @Override protected Component getDefaultName() { return Component.translatable("container.machine_fracking_tower"); }
    ...
    public void provideInfo(UpgradeType type, int lvl, List<String> components, boolean extendedInfo) {
        components.add(IUpgradeInfoProvider.getStandardLabel(NtmBlocks.MACHINE_FRACKING_TOWER.get()).getString());
