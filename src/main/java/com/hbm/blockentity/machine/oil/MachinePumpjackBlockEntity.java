...
public class MachinePumpjackBlockEntity extends OilDrillBaseBlockEntity {
    ...
    public MachinePumpjackBlockEntity(BlockPos pos, BlockState state) {
        super(NtmBlockEntityTypes.PUMPJACK.get(), pos, state);
    }

    @Override protected Component getDefaultName() { return Component.translatable("container.machine_pumpjack"); }
    ...
    public void provideInfo(UpgradeType type, int lvl, List<String> components, boolean extendedInfo) {
        components.add(IUpgradeInfoProvider.getStandardLabel(NtmBlocks.MACHINE_PUMPJACK.get()).getString());
