...
public class BatterySCItem extends EnumMultiItem implements IBatteryItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> components, TooltipFlag flag) {
        ...
        if(pack.power > 0) {
            ...
            components.add(Component.translatable("item." + NuclearTechMod.MODID + ".obj_battery_sc.desc", BobMathUtil.getShortNumber(pack.power) + het).withStyle(ChatFormatting.YELLOW));
        }
    }
}
