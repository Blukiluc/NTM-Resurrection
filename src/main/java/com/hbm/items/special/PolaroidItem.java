...
public class PolaroidItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.translatable("item." + NuclearTechMod.MODID + ".obj_polaroid.desc").withStyle(ChatFormatting.GRAY));
        tooltipComponents.add(Component.empty());
        for(String s : I18nUtil.resolveKeyArray("item." + NuclearTechMod.MODID + ".obj_polaroid.fate" + PolaroidItem.polaroidID)) {
