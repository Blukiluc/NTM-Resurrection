...
public class NtmItems {
    ...
    // public static final DeferredItem<Item> MOLD_NUGGET = ITEMS.register("mold_nugget", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.NUGGET, 1));
    // public static final DeferredItem<Item> MOLD_BILLET = ITEMS.register("mold_billet", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.BILLET, 1));
    public static final DeferredItem<Item> MOLD_PLATE = ITEMS.register("mold_plate", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.PLATE, 1));
    public static final DeferredItem<Item> MOLD_WIRE = ITEMS.register("mold_wire", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.WIRE, 8));
    public static final DeferredItem<Item> MOLD_PLATE_CAST = ITEMS.register("mold_plate_cast", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.CASTPLATE, 1));
    public static final DeferredItem<Item> MOLD_WIRE_DENSE = ITEMS.register("mold_wire_dense", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.DENSEWIRE, 1));
    public static final DeferredItem<Item> MOLD_SHELL = ITEMS.register("mold_shell", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.SHELL, 1));
    public static final DeferredItem<Item> MOLD_PIPE = ITEMS.register("mold_pipe", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.PIPE, 1));
    // public static final DeferredItem<Item> MOLD_PIPES = ITEMS.register("mold_pipes", () -> new Item(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> MOLD_INGOTS = ITEMS.register("mold_ingots", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 1, MaterialShapes.INGOT, 9));
    public static final DeferredItem<Item> MOLD_PLATES = ITEMS.register("mold_plates", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 1, MaterialShapes.PLATE, 9));
    public static final DeferredItem<Item> MOLD_PLATES_CAST = ITEMS.register("mold_plates_cast", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 1, MaterialShapes.CASTPLATE, 3));
    public static final DeferredItem<Item> MOLD_WIRES_DENSE = ITEMS.register("mold_wires_dense", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 1, MaterialShapes.DENSEWIRE, 9));
    // public static final DeferredItem<Item> MOLD_GEM = ITEMS.register("mold_gem", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.GEM, 1));
    // public static final DeferredItem<Item> MOLD_GRIP = ITEMS.register("mold_grip", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.GRIP, 1));
    // public static final DeferredItem<Item> MOLD_STOCK = ITEMS.register("mold_stock", () -> new FoundryMoldItem(new Item.Properties().stacksTo(1), 0, MaterialShapes.STOCK, 1));
    // public static final DeferredItem<Item> MOLD_BLADE = ITEMS.register("mold_blade", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_BLADES = ITEMS.register("mold_blades", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_STAMP = ITEMS.register("mold_stamp", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_C9 = ITEMS.register("mold_c9", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_C44 = ITEMS.register("mold_c44", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_C50 = ITEMS.register("mold_c50", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_C357 = ITEMS.register("mold_c357", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_CBUCKSHOT = ITEMS.register("mold_cbuckshot", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_HULLS = ITEMS.register("mold_hulls", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_HULL_BIG = ITEMS.register("mold_hull_big", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_HULL_SMALL = ITEMS.register("mold_hull_small", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_BARREL_LIGHT = ITEMS.register("mold_barrel_light", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_BARREL_HEAVY = ITEMS.register("mold_barrel_heavy", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_RECEIVER_LIGHT = ITEMS.register("mold_receiver_light", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_RECEIVER_HEAVY = ITEMS.register("mold_receiver_heavy", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_MECHANISM = ITEMS.register("mold_mechanism", () -> new Item(new Item.Properties().stacksTo(1)));
    // public static final DeferredItem<Item> MOLD_MOGUS = ITEMS.register("mold_mogus", () -> new Item(new Item.Properties().stacksTo(1)));
