        ...
        if(!level.isClientSide) {
            if(player.isShiftKeyDown()) {
                ...
                player.displayClientMessage(Component.literal("[" + this.getName(stack).getString() + "] ").withStyle(ChatFormatting.DARK_AQUA)
                        .append(Component.translatable("Position set!").withStyle(ChatFormatting.GREEN)), false);
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        ...
        if(!level.isClientSide) {
            if(!TagsUtil.hasCustomData(stack)) {
                player.displayClientMessage(Component.literal("[" + this.getName(stack).getString() + "] ").withStyle(ChatFormatting.DARK_AQUA)
                        .append(Component.translatable("No position set!").withStyle(ChatFormatting.RED)), false);
            } else {
