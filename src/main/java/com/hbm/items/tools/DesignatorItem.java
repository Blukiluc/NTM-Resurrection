...
public class DesignatorItem extends Item implements IDesignatorItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> components, TooltipFlag flag) {
        if (TagsUtil.hasCustomData(stack)) {
            CompoundTag tag = TagsUtil.getCustomData(stack);
            components.add(Component.translatable("item." + NuclearTechMod.MODID + ".designator.desc.targetPos").withStyle(ChatFormatting.GRAY));
            ...
            components.add(Component.translatable("item." + NuclearTechMod.MODID + ".designator.desc.selectTarget").withStyle(ChatFormatting.GRAY));
        }
    }
