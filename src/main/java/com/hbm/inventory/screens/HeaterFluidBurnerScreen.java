...
import com.hbm.inventory.menus.HeaterFluidBurnerMenu;
...
public class HeaterFluidBurnerScreen extends InfoScreen<HeaterFluidBurnerMenu> {

    private static final ResourceLocation TEXTURE = NuclearTechMod.withDefaultNamespace("textures/gui/machine/gui_fluid_burner.png");

    private final HeaterFluidBurnerBlockEntity be;

    public HeaterFluidBurnerScreen(HeaterFluidBurnerMenu menu, Inventory inventory, Component title) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCustomInfoStat(
                ...
                mouseX,
                mouseY,
                Component.literal(String.format("%,d", Math.min(this.be.heatEnergy, HeaterFluidBurnerBlockEntity.maxHeatEnergy)) + " / " + String.format("%,d", HeaterFluidBurnerBlockEntity.maxHeatEnergy) + " TU")
        );
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        int heat = this.be.heatEnergy * 52 / Math.max(HeaterFluidBurnerBlockEntity.maxHeatEnergy, 1);
