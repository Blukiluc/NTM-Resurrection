...
public class MachineBlastFurnaceScreen extends InfoScreen<MachineBlastFurnaceMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        NeedleGauge.drawSmoothGauge(guiGraphics,this.leftPos + 34, this.topPos + 80, airblast, 5, 2, 1, 0xFF800000);
        NeedleGauge.drawSmoothGauge(guiGraphics, this.leftPos + 34, this.topPos + 26, flue, 5, 2, 1, 0xFF800000);
    }
}
