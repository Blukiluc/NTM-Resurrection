...
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.IRON), 100, 100, null,
//                NtmItems.castPlateIngredient(CastPlateItem.Type.IRON, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.STEEL), 100, 500, null,
//                NtmItems.castPlateIngredient(CastPlateItem.Type.STEEL, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.COPPER), 200, 1_000, null,
//                NtmItems.castPlateIngredient(CastPlateItem.Type.COPPER, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.TITANIUM), 600, 50_000, null,
//                NtmItems.castPlateIngredient(CastPlateItem.Type.TITANIUM, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.ZIRCONIUM), 600, 10_000, null,
//                NtmItems.castPlateIngredient(CastPlateItem.Type.ZIRCONIUM, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.ALUMINIUM), 300, 10_000, null,
//                NtmItems.castPlateIngredient(CastPlateItem.Type.ALUMINIUM, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.TCALLOY), 1_200, 1_000_000,
//                new FluidStack(Fluids.OXYGEN, 1_000), NtmItems.castPlateIngredient(CastPlateItem.Type.TCALLOY, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.CDALLOY), 1_200, 1_000_000,
//                new FluidStack(Fluids.OXYGEN, 1_000), NtmItems.castPlateIngredient(CastPlateItem.Type.CDALLOY, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.TUNGSTEN), 1_200, 250_000,
//                new FluidStack(Fluids.OXYGEN, 1_000), NtmItems.castPlateIngredient(CastPlateItem.Type.TUNGSTEN, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.COMBINE_STEEL), 1_200, 10_000_000,
//                new FluidStack(Fluids.REFORMGAS, 1_000), NtmItems.castPlateIngredient(CastPlateItem.Type.COMBINE_STEEL, 2));
//
//        addRecipe(MetaHelper.newStack(NtmItems.CAST_PLATE_WELDED.get(), 1, CastPlateItem.Type.OSMIRIDIUM), 6_000, 20_000_000,
//                new FluidStack(Fluids.REFORMGAS, 16_000), NtmItems.castPlateIngredient(CastPlateItem.Type.OSMIRIDIUM, 2));
//
...
//                new ComparableStack(NtmItems.THRUSTER_LARGE.get(), 3));
        ...
        addRecipe(new ItemStack(NtmItems.MISSILE_VOLCANO.get()), 600, 50_000, null,
                new ComparableStack(NtmItems.INGOT_URANIUM.get(), 1),
                new ComparableStack(NtmItems.PLATE_IRON.get(), 1),
                new ComparableStack(NtmItems.CINNABAR.get(), 3));
