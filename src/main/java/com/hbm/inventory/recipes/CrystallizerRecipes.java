...
public class CrystallizerRecipes extends SerializableRecipe {
    ...
    public final LinkedHashMap<Pair<ComparableStack, FluidType>, CrystallizerRecipe> recipes = new LinkedHashMap<>();
    ...
    public void registerDefaults() {
        ...
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_CALCIUM.get()), new CrystallizerRecipe(new ItemStack(NtmItems.POWDER_CEMENT.get(), 8), utilityTime).prod(0.1F), new FluidStack(Fluids.REDMUD, 75));
        this.registerRecipe(new ComparableStack(NtmBlocks.GRAVEL_OBSIDIAN.get()), new CrystallizerRecipe(new ItemStack(NtmBlocks.BRICK_OBSIDIAN.get()), utilityTime));
        this.registerRecipe(new ComparableStack(net.minecraft.world.item.Items.ROTTEN_FLESH), new CrystallizerRecipe(new ItemStack(net.minecraft.world.item.Items.LEATHER), utilityTime).prod(0.25F));
        this.registerRecipe(new ComparableStack(NtmItems.COAL_INFERNAL.get()), new CrystallizerRecipe(new ItemStack(NtmItems.SOLID_FUEL.get()), utilityTime));
        this.registerRecipe(new ComparableStack(net.minecraft.world.item.Items.BONE), new CrystallizerRecipe(new ItemStack(net.minecraft.world.item.Items.SLIME_BALL, 16), mixingTime), new FluidStack(Fluids.SULFURIC_ACID, 1_000));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_DIAMOND.get()), new CrystallizerRecipe(new ItemStack(net.minecraft.world.item.Items.DIAMOND), utilityTime));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_EMERALD.get()), new CrystallizerRecipe(new ItemStack(net.minecraft.world.item.Items.EMERALD), utilityTime));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_LAPIS.get()), new CrystallizerRecipe(new ItemStack(net.minecraft.world.item.Items.LAPIS_LAZULI), utilityTime));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_SEMTEX_MIX.get()), new CrystallizerRecipe(new ItemStack(NtmItems.INGOT_SEMTEX.get()), baseTime));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_DESH_READY.get()), new CrystallizerRecipe(new ItemStack(NtmItems.INGOT_DESH.get()), baseTime));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_METEORITE.get()), new CrystallizerRecipe(new ItemStack(NtmItems.FRAGMENT_METEORITE.get()), utilityTime));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_SAWDUST.get()), new CrystallizerRecipe(new ItemStack(NtmItems.CORDITE.get()), mixingTime).prod(0.25F), new FluidStack(Fluids.NITROGLYCERIN, 250));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_IMPURE_OSMIRIDIUM.get()), new CrystallizerRecipe(new ItemStack(NtmItems.CRYSTAL_OSMIRIDIUM.get()), baseTime), new FluidStack(Fluids.SCHRABIDIC, 1_000));
        this.registerRecipe(new ComparableStack(Blocks.SAND), new CrystallizerRecipe(new ItemStack(Blocks.CLAY), mixingTime), new FluidStack(Fluids.COLLOID, 1_000));
        this.registerRecipe(new ComparableStack(NtmItems.POWDER_QUARTZ.get()), new CrystallizerRecipe(new ItemStack(NtmItems.BALL_DYNAMITE.get(), 4), mixingTime), new FluidStack(Fluids.NITROGLYCERIN, 250));
    }

    private void registerOre(ItemLike input, ItemLike output, int duration, FluidStack fluid) {
        this.registerRecipe(new ComparableStack(input.asItem()), new CrystallizerRecipe(new ItemStack(output), duration).prod(0.05F), fluid);
    }

    public CrystallizerRecipe getOutput(ItemStack stack, FluidType type) {
        if(stack.isEmpty()) return null;

        int meta = MetaHelper.getMeta(stack);
        for(Entry<Pair<ComparableStack, FluidType>, CrystallizerRecipe> entry : this.recipes.entrySet()) {
    ...
    public void registerRecipe(ComparableStack input, CrystallizerRecipe recipe) {
        this.registerRecipe(input, recipe, new FluidStack(Fluids.PEROXIDE, 500));
    }

    public void registerRecipe(ComparableStack input, CrystallizerRecipe recipe, FluidStack fluid) {
    ...
    public void readRecipe(JsonElement recipe) {
        ...
        if(input instanceof ComparableStack comparable) {
            CrystallizerRecipe crystallizerRecipe = new CrystallizerRecipe(output, duration).setReq(comparable.stacksize).prod(productivity);
            this.registerRecipe(new ComparableStack(comparable.item, 1, comparable.meta), crystallizerRecipe, fluid);
        }
    }
    ...
    public void writeRecipe(Object recipe, JsonWriter writer) throws IOException {
        Entry<Pair<ComparableStack, FluidType>, CrystallizerRecipe> entry = (Entry<Pair<ComparableStack, FluidType>, CrystallizerRecipe>) recipe;
        ComparableStack keyInput = entry.getKey().getKey();
        CrystallizerRecipe crystallizerRecipe = entry.getValue();
        ComparableStack input = new ComparableStack(keyInput.item, crystallizerRecipe.itemAmount, keyInput.meta);

        writer.name("duration").value(crystallizerRecipe.duration);
        writer.name("fluid");
        SerializableRecipe.writeFluidStack(new FluidStack(entry.getKey().getValue(), crystallizerRecipe.acidAmount), writer);
        writer.name("input");
        SerializableRecipe.writeAStack(input, writer);
        writer.name("output");
        SerializableRecipe.writeItemStack(crystallizerRecipe.output, writer);
        writer.name("productivity").value(crystallizerRecipe.productivity);
    }
