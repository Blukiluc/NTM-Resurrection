...
public class CatalyticCrackingTowerRecipes extends SerializableRecipe {

    public static final CatalyticCrackingTowerRecipes INSTANCE = new CatalyticCrackingTowerRecipes();
    ...
    public static LinkedHashMap<FluidType, Pair<FluidStack, FluidStack>> cracking = new LinkedHashMap<>();

    private CatalyticCrackingTowerRecipes() { }
    ...
    protected static LinkedHashMap<FluidType, Pair<FluidStack, FluidStack>> getCrackingRecipes() {
        return cracking;
    }

    // todo nei
//    public static LinkedHashMap<Object, Object> getCrackingRecipesForNEI() {
//
//        LinkedHashMap<Object, Object> recipes = new LinkedHashMap<>();
//
...
//    }
    ...
    public void writeRecipe(Object recipe, JsonWriter writer) throws IOException {
        ...
        writer.name("input").value(rec.getKey().getName().getString());
