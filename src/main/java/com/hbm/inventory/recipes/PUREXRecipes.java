...
public class PUREXRecipes extends GenericRecipes<GenericRecipe> {
    ...
    public void registerDefaults() {
        this.register(new GenericRecipe("purex.uzh").setup(600, 1_000)
                .inputItems(
                        new ComparableStack(NtmItems.BILLET_URANIUM_FUEL.get()),
                        new ComparableStack(NtmItems.BILLET_ZIRCONIUM.get(), 3))
                .inputFluids(
                        new FluidStack(Fluids.NITRIC_ACID, 1_000),
                        new FluidStack(Fluids.HYDROGEN, 4_000))
                .outputItems(new ItemStack(NtmItems.BILLET_UZH.get(), 4)));

//        this.register(new GenericRecipe("purex.flashgold").setup(600, 1_000)
//                .inputItems(
//                        new ComparableStack(NtmItems.BILLET_AU198.get()),
...
//                .outputItems(new ItemStack(NtmItems.BILLET_BALEFIRE_GOLD.get(), 2)));
        ...
        this.register(new GenericRecipe("purex.flashlead").setup(600, 1_000)
                .inputItems(
                        new ComparableStack(NtmItems.BILLET_PB209.get()),
                        new ComparableStack(NtmItems.BILLET_BALEFIRE_GOLD.get()))
                .inputFluids(new FluidStack(Fluids.AMAT, 1_000))
                .outputItems(new ItemStack(NtmItems.BILLET_FLASHLEAD.get())));
        ...
        this.register(new GenericRecipe("purex.schraranium").setup(200, 1_000).setNameWrapper("purex.schrab")
                ...
                .inputFluids(
                        new FluidStack(Fluids.KEROSENE, 2_000),
                        new FluidStack(Fluids.NITRIC_ACID, 1_000))
                .outputItems(
                        new ItemStack(NtmItems.NUGGET_SCHRABIDIUM.get(), 3),
