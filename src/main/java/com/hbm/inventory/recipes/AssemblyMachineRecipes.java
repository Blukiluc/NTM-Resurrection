...
import com.hbm.items.machine.PistonSetItem.PistonType;
...
public class AssemblyMachineRecipes extends GenericRecipes<GenericRecipe> {
    ...
    public void registerDefaults() {
        ...
        this.register(new GenericRecipe("ass.plateiron").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_IRON.get()))
                .inputItems(new ComparableStack(Items.IRON_INGOT))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.plategold").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_GOLD.get()))
                .inputItems(new ComparableStack(Items.GOLD_INGOT))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platetitanium").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_TITANIUM.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_TITANIUM.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platealu").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_ALUMINIUM.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_ALUMINIUM.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platesteel").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_STEEL.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_STEEL.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platelead").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_LEAD.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_LEAD.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platecopper").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_COPPER.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_INDUSTRIAL_COPPER.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.plateschrab").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_SCHRABIDIUM.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_SCHRABIDIUM.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platecmb").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_COMBINE_STEEL.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_COMBINE_STEEL.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.plategunmetal").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_GUNMETAL.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_GUNMETAL.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.plateweaponsteel").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_WEAPONSTEEL.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_WEAPONSTEEL.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platesaturnite").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_SATURNITE.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_SATURNITE.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));
        this.register(new GenericRecipe("ass.platedura").setup(60, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_DURA_STEEL.get()))
                .inputItems(new ComparableStack(NtmItems.INGOT_DURA_STEEL.get()))
                .setPools(GenericRecipes.POOL_PREFIX_ALT + "plates").setGroup(autoPlate, this));

        this.register(new GenericRecipe("ass.platemixed").setup(50, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_MIXED.get(), 4))
                .inputItems(
                        new ComparableStack(NtmItems.PLATE_COPPER.get(), 2),
                        new ComparableStack(NtmItems.NEUTRON_REFLECTOR.get()),
                        new ComparableStack(NtmItems.PLATE_SATURNITE.get())));
        this.register(new GenericRecipe("ass.platedesh").setup(200, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_DESH.get(), 4))
                .inputItems(
                        new ComparableStack(NtmItems.INGOT_DESH.get(), 4),
                        new ComparableStack(NtmItems.POWDER_POLYMER.get(), 2),
                        new ComparableStack(NtmItems.INGOT_DURA_STEEL.get())));
        this.register(new GenericRecipe("ass.platebismuth").setup(200, 100)
                .outputItems(new ItemStack(NtmItems.PLATE_BISMUTH.get()))
                .inputItems(
                        new ComparableStack(NtmItems.NUGGET_BISMUTH.get(), 2),
                        new ComparableStack(NtmItems.BILLET_U238.get(), 2),
                        new ComparableStack(NtmItems.POWDER_NIOBIUM.get())));

        // Batteries
        this.register(new GenericRecipe("ass.capacitorgold").setup(100, 100)
                .outputItems(MetaHelper.newStack(NtmItems.BATTERY_PACK.get(), BatteryPackType.CAPACITOR_GOLD))
                .inputItems(
                        new ComparableStack(NtmItems.PLATE_STEEL.get(), 8),
                        new ComparableStack(Mats.MAT_GOLD.getItem(MaterialShapes.DENSEWIRE), 16)));
        this.register(new GenericRecipe("ass.capacitortantalum").setup(100, 10_000)
                .outputItems(MetaHelper.newStack(NtmItems.BATTERY_PACK.get(), BatteryPackType.CAPACITOR_TANTALUM))
                .inputItems(
                        new ComparableStack(NtmItems.INGOT_PC.get(), 16),
                        new ComparableStack(NtmItems.INGOT_TANTALIUM.get(), 24)));

        // Generator parts
        this.register(new GenericRecipe("ass.pistonsetsteel").setup(200, 100)
                .outputItems(MetaHelper.newStack(NtmItems.PISTON_SET.get(), PistonType.STEEL))
                .inputItems(
                        ...
                        new ComparableStack(Mats.MAT_TUNGSTEN.getItem(MaterialShapes.BOLT), 16)));

        // Bomb parts
        this.register(new GenericRecipe("ass.explosivelenses1").setup(400, 100)
                .outputItems(new ItemStack(NtmItems.EARLY_EXPLOSIVE_LENSES.get()))
                .inputItems(
                        new ComparableStack(NtmItems.PLATE_ALUMINIUM.get(), 8),
                        new ComparableStack(NtmBlocks.DET_CORD.get(), 8),
                        new ComparableStack(NtmItems.PLATE_SATURNITE.get(), 2),
                        new ComparableStack(NtmItems.INGOT_SEMTEX.get(), 20),
                        new ComparableStack(NtmItems.INGOT_POLYMER.get(), 4)));
        this.register(new GenericRecipe("ass.explosivelenses2").setup(400, 100)
                .outputItems(new ItemStack(NtmItems.EXPLOSIVE_LENSES.get()))
                .inputItems(
                        new ComparableStack(NtmItems.PLATE_ALUMINIUM.get(), 8),
                        new ComparableStack(NtmItems.INGOT_SEMTEX.get(), 4),
                        new ComparableStack(NtmItems.NEUTRON_REFLECTOR.get(), 2),
                        new ComparableStack(NtmItems.BALL_TATB.get(), 16),
                        new ComparableStack(NtmItems.INGOT_RUBBER.get(), 2)));
        this.register(new GenericRecipe("ass.wiring").setup(200, 100)
                .outputItems(new ItemStack(NtmItems.GADGET_WIREING.get()))
                .inputItems(new ComparableStack(Mats.MAT_GOLD.getItem(MaterialShapes.WIRE), 24)));
        this.register(new GenericRecipe("ass.core1").setup(1_200, 100)
                .outputItems(new ItemStack(NtmItems.GADGET_CORE.get()))
                .inputItems(
                        new ComparableStack(NtmItems.NUGGET_PU239.get(), 7),
                        new ComparableStack(NtmItems.NUGGET_U238.get(), 3)));
        this.register(new GenericRecipe("ass.boyshield").setup(200, 100)
                .outputItems(new ItemStack(NtmItems.LITTLE_BOY_SHIELDING.get()))
                .inputItems(
        ...
        this.register(new GenericRecipe("ass.boytarget").setup(200, 100)
                ...
                .inputItems(new ComparableStack(NtmItems.NUGGET_U235.get(), 18)));
        this.register(new GenericRecipe("ass.boybullet").setup(200, 100)
                .outputItems(new ItemStack(NtmItems.LITTLE_BOY_BULLET.get()))
                .inputItems(new ComparableStack(NtmItems.NUGGET_U235.get(), 9)));
        this.register(new GenericRecipe("ass.mancore").setup(1_200, 100)
                .outputItems(new ItemStack(NtmItems.FAT_MAN_CORE.get()))
                .inputItems(
                        new ComparableStack(NtmItems.NUGGET_PU239.get(), 8),
                        new ComparableStack(NtmItems.NUGGET_BERYLLIUM.get(), 2)));
        this.register(new GenericRecipe("ass.mikecore").setup(1_200, 100)
                .outputItems(new ItemStack(NtmItems.IVY_MIKE_CORE.get()))
                .inputItems(
                        new ComparableStack(NtmItems.NUGGET_U238.get(), 24),
                        new ComparableStack(NtmItems.PLATE_LEAD.get(), 6)));
        this.register(new GenericRecipe("ass.mikedeut").setup(600, 100)
                .outputItems(new ItemStack(NtmItems.IVY_MIKE_DEUT.get()))
                .inputItems(
                        new ComparableStack(NtmItems.PLATE_WEAPONSTEEL.get(), 16),
                        new ComparableStack(NtmItems.PLATE_TITANIUM.get(), 16))
                .inputFluids(new FluidStack(Fluids.DEUTERIUM, 10_000)));
        this.register(new GenericRecipe("ass.fleijacharge").setup(300, 100)
                .outputItems(new ItemStack(NtmItems.FLEIJA_PROPELLANT.get()))
                .inputItems(
                        new ComparableStack(NtmItems.INGOT_SEMTEX.get(), 3),
                        new ComparableStack(NtmItems.PLATE_SCHRABIDIUM.get(), 8)));
        this.register(new GenericRecipe("ass.soliniumcore").setup(600, 100)
                .outputItems(new ItemStack(NtmItems.SOLINIUM_CORE.get()))
                .inputItems(
                        new ComparableStack(NtmItems.NUGGET_SOLINIUM.get(), 9),
                        new ComparableStack(NtmItems.NUGGET_EUPHEMIUM.get())));
        this.register(new GenericRecipe("ass.soliniumcharge").setup(300, 100)
                .outputItems(new ItemStack(NtmItems.SOLINIUM_PROPELLANT.get()))
                .inputItems(
                        new ComparableStack(NtmItems.INGOT_SEMTEX.get(), 3),
                        new ComparableStack(NtmItems.NEUTRON_REFLECTOR.get(), 2),
                        new ComparableStack(NtmItems.PLATE_POLYMER.get(), 6),
                        new ComparableStack(Mats.MAT_TUNGSTEN.getItem(MaterialShapes.WIRE), 6),
                        new ComparableStack(NtmItems.BIOMASS_COMPRESSED.get(), 4)));

        // Ammo
        this.register(new GenericRecipe("ass.50bmgsm").setup(100, 100)
                .outputItems(MetaHelper.newStack(NtmItems.AMMO_STANDARD.get(), 6, Ammo.BMG50_SM))
                .inputItems(
                        new ComparableStack(NtmItems.CASING.get(), 1, CasingType.LARGE_STEEL.ordinal()),
                        new ComparableStack(NtmItems.CORDITE.get(), 6),
                        new ComparableStack(NtmItems.INGOT_STARMETAL.get(), 3))
                .setPools(GenericRecipes.POOL_PREFIX_DISCOVER + "silverstorm"));

        // Fluid packages
        this.register(new GenericRecipe("ass.emptypackage").setup(40, 100)
                .outputItems(new ItemStack(NtmItems.FLUID_PACK_EMPTY.get()))
                .inputItems(
        ...
        for(int i = 1; i < order.length; ++i) {
            ...
            this.register(new GenericRecipe("ass.package" + type.getUnlocalizedName()).setup(40, 100)
                    .outputItems(MetaHelper.newStack(NtmItems.FLUID_PACK_FULL, 1, type.getID()))
                    .inputItems(new ComparableStack(NtmItems.FLUID_PACK_EMPTY.get()))
                    .inputFluids(new FluidStack(type, 32_000)));
            this.register(new GenericRecipe("ass.unpackage" + type.getUnlocalizedName()).setup(40, 100)
                    .setIcon(FluidIconItem.make(type, 32_000))
                    .outputItems(new ItemStack(NtmItems.FLUID_PACK_EMPTY.get()))
                    .inputItems(new ComparableStack(MetaHelper.newStack(NtmItems.FLUID_PACK_FULL, 1, type.getID())))
                    .outputFluids(new FluidStack(type, 32_000)));
        }

        // Existing project-specific recipes
        this.register(new GenericRecipe("ass.grass_block").setup(200, 100)
                .outputItems(new ItemStack(Blocks.GRASS_BLOCK))
                .inputItems(
                        new ComparableStack(NtmItems.SINGULARITY.get()),
                        new ComparableStack(NtmItems.SINGULARITY_COUNTER_RESONANT.get()),
                        new ComparableStack(NtmItems.MISSILE_DOOMSDAY_RUSTED.get())));
        ...
        /*
         * Original 1.7.10 catalogue
         *
         * Every original Assembly Machine craft is kept below. Recipes whose
         * blocks, items, meta-items or ingredient forms are not available in
         * this port remain commented and can be migrated in place later.
         *
		...
		if(!GeneralConfig.enable528) { // precass otherwise
			...
			this.register(new GenericRecipe("ass.analogAlt").setupNamed(200, 250).outputItems(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ANALOG))
					.inputItems(new ComparableStack(ModItems.circuit, 4, EnumCircuitType.PCB), new OreDictStack(ANY_PLASTIC.ingot(), 4), new OreDictStack(W.wireFine(), 8), new OreDictStack(NB.ingot())).setPools(POOL_PREFIX_ALT + ".circuit"));
