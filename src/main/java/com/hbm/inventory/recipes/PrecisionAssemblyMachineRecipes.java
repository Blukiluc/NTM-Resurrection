...
public class PrecisionAssemblyMachineRecipes extends GenericRecipes<GenericRecipe> {

    public static final PrecisionAssemblyMachineRecipes INSTANCE = new PrecisionAssemblyMachineRecipes();
