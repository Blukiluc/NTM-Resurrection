...
public class Fluids {
    ...
    public static void init() {
        ...
        SCHRABIDIC =            new FluidType("SCHRABIDIC",         0x006B6B, 5, 0, 5, EnumSymbol.ACID).addTraits(new FT_VentRadiation(1F), new FT_Corrosive(75), new FT_Poison(3, 2), LIQUID);
        ...
        MERCURY =               new FluidType("MERCURY",            0x808080, 2, 0, 0, EnumSymbol.NONE).addTraits(LIQUID, new FT_Poison(3, 2));
        PAIN =                  new FluidType("PAIN",               0x938541, 2, 0, 1, EnumSymbol.ACID).setTemp(300).addTraits(new FT_Corrosive(30), new FT_Poison(3, 2), LIQUID, VISCOUS);
        ...
        FRACKSOL =              new FluidType("FRACKSOL",           0x798A6B, 1, 3, 3, EnumSymbol.ACID).addContainers(new CD_Canister(0x4F887F)).addTraits(new FT_Corrosive(15), new FT_Poison(2, 0), LIQUID, VISCOUS);
        ...
        DEATH =                 new FluidType("DEATH",              0x717A88, 2, 0, 1, EnumSymbol.ACID).setTemp(300).addTraits(new FT_Corrosive(80), new FT_Poison(3, 4), LEADCON, LIQUID, VISCOUS);
        ...
        UNSATURATEDS =          new FluidType("UNSATURATEDS",       0x628FAE, 1, 4, 1, EnumSymbol.NONE).addContainers(new CD_Gastank(0x628FAE, 0xEDCF27)).addTraits(new FT_Flammable(1_000_000), GASEOUS, P_GAS);
        ...
        BLOOD_HOT =             new FluidType("BLOOD_HOT",          0xF22419, 3, 0, 0, EnumSymbol.NONE).addTraits(LIQUID, VISCOUS).setTemp(666);
        ...
        HEAVYOIL_VACUUM =        new FluidType("HEAVYOIL_VACUUM",     0x131214, 2, 1, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0x513F39)).addTraits(new FT_Flammable(50_000), new FT_Combustible(FuelGrade.LOW, 25_000), LIQUID, VISCOUS, P_OIL);
        REFORMATE =             new FluidType("REFORMATE",          0x835472, 2, 2, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0xD180D6)).addTraits(new FT_Flammable(250_000), new FT_Combustible(FuelGrade.HIGH, 600_000), LIQUID, VISCOUS, P_FUEL);
        LIGHTOIL_VACUUM =        new FluidType("LIGHTOIL_VACUUM",     0x8C8851, 1, 2, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0xB46B52)).addTraits(new FT_Flammable(200_000), new FT_Combustible(FuelGrade.MEDIUM, 500_000), LIQUID, P_FUEL);
        SOURGAS =                new FluidType("SOURGAS",             0xC9BE0D, 4, 4, 0, EnumSymbol.ACID).addContainers(new CD_Gastank(0xC9BE0D, 0x303030)).addTraits(new FT_Flammable(10_000), GASEOUS, new FT_Corrosive(10), new FT_Poison(3, 1), new FT_Polluting().burn(PollutionType.SOOT, SOOT_GAS).release(PollutionType.POISON, POISON_EXTREME));
        ...
        HEATINGOIL_VACUUM =      new FluidType("HEATINGOIL_VACUUM",   0x211D06, 2, 2, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0x694235)).addTraits(new FT_Flammable(150_000), new FT_Combustible(FuelGrade.LOW, 100_000), LIQUID, VISCOUS, P_OIL);
        DIESEL_REFORM =          new FluidType("DIESEL_REFORM",     0xCDC3C6, 1, 2, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0xFFC500)).addTraits(new FT_Flammable(250_000), new FT_Combustible(FuelGrade.HIGH, 600_000), LIQUID, P_FUEL);
        DIESEL_CRACK_REFORM =  new FluidType("DIESEL_CRACK_REFORM", 0xCDC3CC, 1, 2, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0xFFC500)).addTraits(new FT_Flammable(250_000), new FT_Combustible(FuelGrade.HIGH, 550_000), LIQUID, P_FUEL);
        KEROSENE_REFORM =        new FluidType("KEROSENE_REFORM",     0xFFA5F3, 1, 2, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0xFF377D)).addTraits(new FT_Flammable(350_000), new FT_Combustible(FuelGrade.AERO, 1_500_000), LIQUID, P_FUEL);
        REFORMGAS =              new FluidType("REFORMGAS",         0x6362AE, 1, 4, 1, EnumSymbol.NONE).addContainers(new CD_Gastank(0x9392FF, 0xFFB992)).addTraits(new FT_Flammable(25_000), new FT_Combustible(FuelGrade.GAS, 50_000), GASEOUS, P_GAS);
        ...
        OIL_COKER =              new FluidType("OIL_COKER",           0x001802, 2, 1, 0, EnumSymbol.NONE).addTraits(new FT_Flammable(10_000), LIQUID, VISCOUS, P_OIL);
        GAS_COKER =              new FluidType("GAS_COKER",           0xDEF4CA, 1, 4, 0, EnumSymbol.NONE).addTraits(new FT_Flammable(10_000), new FT_Combustible(FuelGrade.GAS, 25_000), GASEOUS, P_GAS);
        NAPHTHA_COKER =          new FluidType("NAPHTHA_COKER",       0x495944, 2, 1, 0, EnumSymbol.NONE).addTraits(new FT_Flammable(125_000), new FT_Combustible(FuelGrade.MEDIUM, 200_000), LIQUID, VISCOUS, P_OIL);
        ...
        OIL_DS =                new FluidType("OIL_DS",              0x121212, 2, 1, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0x424242)).addTraits(new FT_Flammable(10_000), LIQUID, VISCOUS, P_OIL);
        CRACKOIL_DS =            new FluidType("CRACKOIL_DS",        0x2A1C11, 2, 1, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0x424242)).addTraits(new FT_Flammable(10_000), LIQUID, VISCOUS, P_OIL);
        ...
        NAPHTHA_DS =            new FluidType("NAPHTHA_DS",          0x63614E, 2, 1, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0x5F6D44)).addTraits(new FT_Flammable(125_000), new FT_Combustible(FuelGrade.MEDIUM, 200_000), LIQUID, VISCOUS, P_FUEL);
        LIGHTOIL_DS =           new FluidType("LIGHTOIL_DS",         0x63543E, 1, 2, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0xB46B52)).addTraits(new FT_Flammable(200_000), new FT_Combustible(FuelGrade.MEDIUM, 500_000), LIQUID, P_FUEL);
        ...
        // Major traits(for turbines for example)
