...
public class Fluids {
    ...
    public static void init() {
        ...
        HEAVYOIL =          new FluidType("HEAVYOIL",       0x141312, 2, 1, 0, EnumSymbol.NONE).addContainers(new CD_Canister(0x513F39)).addTraits(new FT_Flammable(50_000), new FT_Combustible(FT_Combustible.FuelGrade.LOW, 25_000), LIQUID, VISCOUS, P_OIL);
        ...
        AIRBLAST =          new FluidType("AIRBLAST",       0xFFDADA, 0, 3, 0, EnumSymbol.NONE).setTemp(1200).addTraits(GASEOUS);
