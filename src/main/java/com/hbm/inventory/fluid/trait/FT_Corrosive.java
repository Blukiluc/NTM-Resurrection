...
public class FT_Corrosive extends FluidTrait {
    ...
    public void addInfo(List<Component> info) {
        if (this.isHighlyCorrosive()) {
            info.add(Component.translatable("Strongly Corrosive").withStyle(ChatFormatting.GOLD));
        } else  {
            info.add(Component.translatable("Corrosive").withStyle(ChatFormatting.GOLD));
        }
    }
