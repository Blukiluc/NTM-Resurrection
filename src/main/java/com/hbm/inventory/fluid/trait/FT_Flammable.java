...
public class FT_Flammable extends FluidTrait {
    ...
    public void addInfo(List<Component> info) {
        ...
        info.add(Component.translatable("[Flammable]").withStyle(ChatFormatting.YELLOW));

        if (energy > 0)  info.add(
                Component.literal("Provides ")
                        .withStyle(ChatFormatting.YELLOW)
                        .append(Component.literal(BobMathUtil.getShortNumber(energy) + " MTU").withStyle(ChatFormatting.RED))
