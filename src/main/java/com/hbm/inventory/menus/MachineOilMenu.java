...
public class MachineOilMenu extends MenuBase<OilDrillBaseBlockEntity> {

    public MachineOilMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
        this(id, inventory, (OilDrillBaseBlockEntity) CompatExternal.getCoreFromPos(inventory.player.level(), extraData.readBlockPos()));
    }

    public MachineOilMenu(int id, Inventory inventory, OilDrillBaseBlockEntity be) {
        super(NtmMenuTypes.MACHINE_OIL.get(), be, id);
