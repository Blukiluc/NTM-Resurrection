...
public class MixerRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public MixerRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.MIXER; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_mixer"); }
