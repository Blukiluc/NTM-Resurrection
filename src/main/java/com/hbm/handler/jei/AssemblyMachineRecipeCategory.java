...
public class AssemblyMachineRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public AssemblyMachineRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.ASSEMBLY_MACHINE; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_assembly_machine"); }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, GenericRecipe recipe, IFocusGroup focuses) {
        ...
        // --- INPUT ITEMS : grille simple 6 par ligne, 18px de pas ---
        ...
        // --- INPUT FLUIDS : traités comme des items via FluidIconItem, sous les inputs solides ---
        ...
        // --- OUTPUT FLUIDS : sous les outputs solides, même colonne ---
