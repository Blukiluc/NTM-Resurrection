...
public class PurexRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public PurexRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.PUREX; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_purex"); }
