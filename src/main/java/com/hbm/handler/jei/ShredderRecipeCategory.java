...
public class ShredderRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.SHREDDER; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_shredder"); }
