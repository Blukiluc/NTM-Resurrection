...
public class SolderingStationRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public SolderingStationRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.SOLDERING_STATION; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_soldering_station"); }
