...
public class GasCentrifugeRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public GasCentrifugeRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.GAS_CENTRIFUGE; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_gas_centrifuge"); }
