...
public class CentrifugeRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.CENTRIFUGE; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_centrifuge"); }
