...
public class ArcWelderRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.ARC_WELDER; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_arc_welder"); }
