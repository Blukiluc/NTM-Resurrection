...
public class PressRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.PRESS; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_press"); }
