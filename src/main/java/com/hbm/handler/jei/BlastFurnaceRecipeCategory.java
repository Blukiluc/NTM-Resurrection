...
public class BlastFurnaceRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public BlastFurnaceRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.BLAST_FURNACE; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_blast_furnace"); }
