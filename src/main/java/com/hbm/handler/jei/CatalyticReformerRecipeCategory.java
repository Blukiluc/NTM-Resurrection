...
public class CatalyticReformerRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public CatalyticReformerRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.CATALYTIC_REFORMER; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_catalytic_reformer"); }
