...
public class ElectrolyserFluidRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public ElectrolyserFluidRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.ELECTROLYSER_FLUID; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_electrolyser_fluid"); }
