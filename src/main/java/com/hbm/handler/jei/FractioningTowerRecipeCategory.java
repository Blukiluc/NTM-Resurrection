...
public class FractioningTowerRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public FractioningTowerRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.FRACTIONING_TOWER; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_fractioning_tower"); }
