...
public class PrecisionAssemblyMachineRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public PrecisionAssemblyMachineRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.PRECISION_ASSEMBLY_MACHINE; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_precision_assembly_machine"); }
