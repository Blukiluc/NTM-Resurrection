...
public class SilexRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public SilexRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.SILEX; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_silex"); }
