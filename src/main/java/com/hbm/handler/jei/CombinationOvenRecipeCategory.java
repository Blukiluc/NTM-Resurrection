...
public class CombinationOvenRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public CombinationOvenRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.COMBINATION_OVEN; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_combination_oven"); }
