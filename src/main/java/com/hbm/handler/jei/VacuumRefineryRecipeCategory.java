...
public class VacuumRefineryRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public VacuumRefineryRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.VACUUM_REFINERY; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_vacuum_refinery"); }
