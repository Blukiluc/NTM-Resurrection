...
public class ElectrolyserMetalRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public ElectrolyserMetalRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.ELECTROLYSER_METAL; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_electrolyser_metal"); }
