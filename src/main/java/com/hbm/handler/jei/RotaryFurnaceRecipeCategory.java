...
public class RotaryFurnaceRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public RotaryFurnaceRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.ROTARY_FURNACE; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_rotary_furnace"); }
