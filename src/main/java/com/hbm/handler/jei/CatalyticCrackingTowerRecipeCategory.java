...
public class CatalyticCrackingTowerRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public CatalyticCrackingTowerRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.CATALYTIC_CRACKING_TOWER; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_catalytic_cracking_tower"); }
