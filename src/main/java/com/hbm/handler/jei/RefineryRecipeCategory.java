...
public class RefineryRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.REFINERY; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_refinery"); }
