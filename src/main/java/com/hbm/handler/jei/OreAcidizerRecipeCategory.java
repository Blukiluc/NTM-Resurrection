...
public class OreAcidizerRecipeCategory implements IRecipeCategory<GenericRecipe> {
    ...
    public OreAcidizerRecipeCategory(IGuiHelper gui) {
    ...
    @Override public RecipeType<GenericRecipe> getRecipeType() { return NtmJeiRecipeTypes.ORE_ACIDIZER; }
    @Override public Component getTitle() { return Component.translatable("block.hbm.machine_ore_acidizer"); }
