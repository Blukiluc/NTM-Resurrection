...
public class RenderBobble extends BlockEntityRendererNT<BobbleBlockEntity> implements IBEWLRProvider {
    ...
    public static final ResourceLocation BOBBLE_BLUKILUC_TEX = NuclearTechMod.withDefaultNamespace("textures/models/trinkets/blukiluc.png");
    public static final ResourceLocation BOBBLE_KAADER_TEX = NuclearTechMod.withDefaultNamespace("textures/models/trinkets/kaader.png");
    ...
    public void renderBobble(BobbleType type, MultiBufferSource buffer) {
        ...
        switch(type) {
            ...
            case BLUKILUC ->      bindTexture(BOBBLE_BLUKILUC_TEX);
            case KAADER ->      bindTexture(BOBBLE_KAADER_TEX);
