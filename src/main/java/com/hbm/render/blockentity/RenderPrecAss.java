...
public class RenderPrecAss extends BlockEntityRendererNT<MachinePrecAssBlockEntity> implements IBEWLRProvider {
    ...
    @Override
    public BlockEntityRenderer<MachinePrecAssBlockEntity> create(Context context) {
        return new RenderPrecAss();
    }

    @Override
    public void render(MachinePrecAssBlockEntity be, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
