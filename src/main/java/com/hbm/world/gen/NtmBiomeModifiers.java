...
//    public static final ResourceKey<BiomeModifier> ADD_AUSTRALIUM_DEPOSIT = registerKey("add_australium_deposit");
    ...
    public static final ResourceKey<BiomeModifier> ADD_ORE_NETHER_URANIUM = registerKey("add_ore_nether_uranium");
//    public static final ResourceKey<BiomeModifier> ADD_ORE_NETHER_TUNGSTEN = registerKey("add_ore_nether_tungsten");
//    public static final ResourceKey<BiomeModifier> ADD_ORE_NETHER_SULFUR = registerKey("add_ore_nether_sulfur");
//    public static final ResourceKey<BiomeModifier> ADD_ORE_NETHER_PHOSPHORUS = registerKey("add_ore_nether_phosphorus");
//    public static final ResourceKey<BiomeModifier> ADD_ORE_NETHER_COAL = registerKey("add_ore_nether_coal");
//    public static final ResourceKey<BiomeModifier> ADD_ORE_NETHER_COBALT = registerKey("add_ore_nether_cobalt");
    public static final ResourceKey<BiomeModifier> ADD_ORE_NETHER_PLUTONIUM = registerKey("add_ore_nether_plutonium");

    public static final ResourceKey<BiomeModifier> ADD_ORE_END_TIKITE = registerKey("add_ore_end_tikite");
...
//        context.register(ADD_AUSTRALIUM_DEPOSIT, new BiomeModifiers.AddFeaturesBiomeModifier(overworldBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.AUSTRALIUM_DEPOSIT_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(ADD_ORE_NETHER_URANIUM, new BiomeModifiers.AddFeaturesBiomeModifier(netherBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_NETHER_URANIUM_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
//        context.register(ADD_ORE_NETHER_TUNGSTEN, new BiomeModifiers.AddFeaturesBiomeModifier(netherBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_NETHER_TUNGSTEN_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
//        context.register(ADD_ORE_NETHER_SULFUR, new BiomeModifiers.AddFeaturesBiomeModifier(netherBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_NETHER_SULFUR_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
//        context.register(ADD_ORE_NETHER_PHOSPHORUS, new BiomeModifiers.AddFeaturesBiomeModifier(netherBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_NETHER_PHOSPHORUS_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
//        context.register(ADD_ORE_NETHER_COAL, new BiomeModifiers.AddFeaturesBiomeModifier(netherBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_NETHER_COAL_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
//        context.register(ADD_ORE_NETHER_COBALT, new BiomeModifiers.AddFeaturesBiomeModifier(netherBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_NETHER_COBALT_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_ORE_NETHER_PLUTONIUM, new BiomeModifiers.AddFeaturesBiomeModifier(netherBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_NETHER_PLUTONIUM_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(ADD_ORE_END_TIKITE, new BiomeModifiers.AddFeaturesBiomeModifier(endBiomes, HolderSet.direct(placedFeatures.getOrThrow(NtmPlacedFeatures.ORE_END_TIKITE_PLACED)), GenerationStep.Decoration.UNDERGROUND_ORES));
    }
